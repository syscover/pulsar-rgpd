    ...
    <div class="row">
        <div class="col-12">
            ...
            <div>
                ...
                <p>{!! __('web.conditions_8_2_3', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_2_4', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_2_5', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_2_6', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_2_7') !!}</p>
                <p>{!! __('web.conditions_8_2_8', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_2_9') !!}</p>
                <p>{!! __('web.conditions_8_2_10', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h5>{!! __('web.conditions_8_3') !!}</h5>
                <p>{!! __('web.conditions_8_3_1') !!}</p>
                <p>{!! __('web.conditions_8_3_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_3_3', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_3_4', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_3_5', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_3_6', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_8_3_7', ['trademark' => config('pulsar-rgpd.trademark')]) !!}) !!}</p>
                ...
                <p>{!! __('web.conditions_9_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_9_2') !!}</p>

                <h3>{!! __('web.conditions_10') !!}</h3>
                <p>{!! __('web.conditions_10_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_10_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_10_3', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h3>{!! __('web.conditions_11') !!}</h3>
                <p>{!! __('web.conditions_11_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                ...
                <p>{!! __('web.conditions_12_5', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h3>{!! __('web.conditions_13') !!}</h3>
                <p>{!! __('web.conditions_13_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_13_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h3>{!! __('web.conditions_14') !!}</h3>
                <p>{!! __('web.conditions_14_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_14_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h3>{!! __('web.conditions_15') !!}</h3>
                <p>{!! __('web.conditions_15_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_15_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <ul>
                    <li><p>{!! __('web.conditions_15_3') !!}</p></li>
                    <li><p>{!! __('web.conditions_15_4') !!}</p></li>
                    <li><p>{!! __('web.conditions_15_5') !!}</p></li>
                    <li><p>{!! __('web.conditions_15_6', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
                    <li><p>{!! __('web.conditions_15_7', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
                    <li><p>{!! __('web.conditions_15_8', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
                    <li><p>{!! __('web.conditions_15_9', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
                ...
                <p>{!! __('web.conditions_17_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_17_2') !!}</p>
                ...
                <p>{!! __('web.conditions_20_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h3>{!! __('web.conditions_21') !!}</h3>
                <p>{!! __('web.conditions_21_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <ul>
                ...
                <p>{!! __('web.conditions_21_11', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

                <h3>{!! __('web.conditions_22') !!}</h3>
                <p>{!! __('web.conditions_22_1') !!}</p>
                <p>{!! __('web.conditions_22_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
                <p>{!! __('web.conditions_22_3') !!}</p>
                <p>{!! __('web.conditions_22_4', ['update_date' => config('pulsar-rgpd.update_date')]) !!}</p>
            </div>
        </div>
    </div>
</div>
