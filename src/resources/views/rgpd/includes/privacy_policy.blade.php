<div class="rgpd">
    ...
    <div>
        ...
        <ul>
            ...
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_1_9', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_1_10') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_1_11') !!}</p></li>
        </ul>
        <p>{!! __('rgpd-privacy_policy.privacy_4_1_12', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
        <p>{!! __('rgpd-privacy_policy.privacy_4_1_13') !!}</p>
        <ul>
        ...
        <p>{!! __('rgpd-privacy_policy.privacy_4_1_21') !!}</p>
        ...
        <ul>
            ...
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_2_3') !!}</p></li>
            ...
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_2_8', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_2_9', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_4_2_10', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
        </ul>

        <h3>{!! __('rgpd-privacy_policy.privacy_5') !!}</h3>
        ...
        <ul>
            ...
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_3') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_4') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_5', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            ...
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_10', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_11') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_12') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_2_13', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
        </ul>

        <h5>{!! __('rgpd-privacy_policy.privacy_5_3', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</h5>
        <ul>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_3_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_3_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_3_3') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_5_3_4', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
        </ul>

        <h5>{!! __('rgpd-privacy_policy.privacy_5_4') !!}</h5>
        <p>{!! __('rgpd-privacy_policy.privacy_5_4_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

        <h3>{!! __('rgpd-privacy_policy.privacy_6') !!}</h3>
        <p>{!! __('rgpd-privacy_policy.privacy_6_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

        <h3>{!! __('rgpd-privacy_policy.privacy_7') !!}</h3>
        <p>{!! __('rgpd-privacy_policy.privacy_7_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
        <ul>
            <li><p>{!! __('rgpd-privacy_policy.privacy_7_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_7_3', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_7_4', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_7_5') !!}</p></li>
            <li><p>{!! __('rgpd-privacy_policy.privacy_7_6', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p></li>
        </ul>

        <h3>{!! __('rgpd-privacy_policy.privacy_8') !!}</h3>
        <p>{!! __('rgpd-privacy_policy.privacy_8_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

        <h3>{!! __('rgpd-privacy_policy.privacy_9') !!}</h3>
        <p>{!! __('rgpd-privacy_policy.privacy_9_1', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>
        <p>{!! __('rgpd-privacy_policy.privacy_9_2', ['trademark' => config('pulsar-rgpd.trademark')]) !!}</p>

        <h3>{!! __('rgpd-privacy_policy.privacy_10') !!}</h3>
        <p>{!! __('rgpd-privacy_policy.privacy_10_1') !!}</p>
        ...
        <p>{!! __('rgpd-privacy_policy.privacy_14_1', ['update_date' => config('pulsar-rgpd.update_date')]) !!}</p>
    </div>
</div>
